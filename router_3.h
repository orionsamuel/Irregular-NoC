...
SC_MODULE(router){
	...
	flow_control *fcN, *fcN2, *fcE, *fcE2, *fcS, *fcS2, *fcW, *fcW2, *fcL, *fcL2;
	...
	SC_CTOR(router){
		...
		fcN2 = new flow_control("fcN2");
		fcE2 = new flow_control("fcE2");
		fcS2 = new flow_control("fcS2");
		fcW2 = new flow_control("fcW2");
		fcL2 = new flow_control("fcL2");
